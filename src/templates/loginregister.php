...
{
	$actcode = md5(rand());
	$insert_status = $wpdb->insert( WSSM_USERPLAN_TABLE_NAME, array('status_type' => 'accesslogin','activation_code' => $actcode));
}
...
<div class="stl-row">
	...
	<div class="stl-col-md-12">
		<div class="stl_ajaxloader"><img src="<?php echo PRELOADER_IMG; ?>" class="img-responsive" /></div>
			...
			<div class="stl-col-md-12">
				<br><p><label>
					<input type="radio" name="stl_lrgform" class="stl_select_login" value="register" checked> <?= _e('Upgrade/Register Account','wp_stripe_management'); ?> 
				</label></p>
					...
					<div class="stl-col-md-12">
						<div class="stl-col-md-6">
					   		<div class="stl-form-group">
								...
								<input type="text" name="full_name" class="stl-form-control" autofocus>
							</div>
					   	</div>
					   	<div class="stl-col-md-6">
					   		<div class="stl-form-group">
								<label><?= _e('Login Email Address','wp_stripe_management'); ?></label>
								<input type="email" name="email" id="email_address" class="stl-form-control">
							</div>
					   	</div>
			...
			<div class="stl-col-md-12">
				<p><label>
					<input type="radio" name="stl_lrgform" class="stl_select_login" value="login" > <?= _e('Login to Existing Account','wp_stripe_management'); ?> 
				</label></p>
				<form id="stl_loginform" name="loginform" method="post">
					...
					<div class="stl-col-md-12">
						<div class="stl-col-md-6">
					   		<div class="stl-form-group">
								<label><?= _e('Login Email Address','wp_stripe_management'); ?></label>
								<input type="email" name="email" class="stl-form-control" autofocus>
							</div>
					   	</div>
